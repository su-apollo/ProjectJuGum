...
CBullet::CBullet()
{
	...
	//°¡¼ÓÅºÈ¯
	m_Texture[RAYMU_ACCEL_BULLET] = NNSpriteAtlas::Create(L"Sprite/BulletR2.png");
	m_Texture[RAYMU_ACCEL_BULLET]->SetImageHeight(2*BULLET_HIT_RADIUS*1.5f);
	m_Texture[RAYMU_ACCEL_BULLET]->SetImageWidth(2*BULLET_HIT_RADIUS);
	...
	//Ä¿ºêÅºÈ¯
	m_Texture[RAYMU_CURVE_BULLET] = NNSpriteAtlas::Create(L"Sprite/BulletR1.png");
	...
	//°Å´ëÅºÈ¯
	m_Texture[MARISA_BIG_BULLET] = NNSpriteAtlas::Create(L"Sprite/BulletB1.png");
	m_Texture[MARISA_BIG_BULLET]->SetImageHeight(2*BULLET_HIT_RADIUS);
	m_Texture[MARISA_BIG_BULLET]->SetImageWidth(2*BULLET_HIT_RADIUS);
